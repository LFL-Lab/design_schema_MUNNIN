...
class LogicalQubit(BaseQubit):  # pylint: disable=invalid-name
...
###################################TRANSMON#############################################################
    ...
    def make_pocket(self):
        ...
        cross_length_long = p.cross_length_long
        ...
        cross_line = draw.shapely.ops.unary_union([
            draw.LineString([(0, cross_length_long), (0, -cross_length)]),
...
############################CONNECTORS##################################################################################################
    ...
    def make_connection_pad(self, name: str):
        ...
        # self.p allows us to directly access parsed values (string -> numbers) form the user option
        p = self.p
        cross_length_long = p.cross_length_long # long arm for couping 
        cross_width = p.cross_width
        cross_length = p.cross_length
        cross_gap = p.cross_gap
        ...
        polys = draw.translate(polys, -(cross_length_long + cross_gap + g_s + c_g),
                               0)
